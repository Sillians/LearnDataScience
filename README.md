## This notebook is a clone of the original repo*, except the notebooks can be viewed, edited and executed in broswer with no dependencies, thanks to free hosting on mybinder.org
